...
Tags: slideshow , animation, animated, gallery, mootools 1.4.5, mootools, slider, superslider, slideshow2, photos
Requires at least: 2.6
Tested up to: 3.5.1
Stable tag: 2.9

Animated Gallery slideshow uses Mootools 1.4.5 javascript replaces wordpress gallery with a slideshow.
...
This slideshow uses [Mootools](http://mootools.net/ "Your favorite javascript framework") 1.4.5 javascript to replace your gallery with a Slideshow. 
...
* [Demo 1](http://superslider.daivmowbray.com/2008/slideshow-demo-1 "Demo 1")
* [Demo 2](http://superslider.daivmowbray.com/2008/slideshow-demo-2 "Demo 2")
* [Demo 3](http://superslider.daivmowbray.com/2008/slideshow-demo-3 "Demo 3")
* [Demo 4](http://superslider.daivmowbray.com/2008/slideshow-demo-4 "Demo 4")
* [Demo 5 multi-color flash](http://superslider.daivmowbray.com/2008/slideshow-demo-5-multi-color-flash "Demo 5 multi-color flash")
* [SlideShow fromfolder demo](http://superslider.daivmowbray.com/2009/slideshow-fromfolder-demo "SlideShow fromfolder demo")
* [Category photos slideshow Black](http://superslider.daivmowbray.com/2009/category-photos-slideshow "Category photos slideshow Black")
* [photos slideshow](http://superslider.daivmowbray.com/2013/slideshow-with-ids/ "Photos slideshow")
...
If you have any problems or suggestions regarding this plugin [please speak up](http://wordpress.org/support/plugin/superslider-show "support forum")
...
In the search box, type in 'SuperSlider-Show' and hit enter. This plugin should be the first and likely the only result.
...
Upload the Superslider-Show folder into your /wp-content/plugins/ directory 
Find the Superslider-Show plugin in the WordPress admin on the 'Plugins' page and click 'Activate'
...
Version 2.8 has some css changes
...
* you should now have the shortcode [gallery idz="12,13,14"] in your post.
* change the shortcode tag from gallery to slideshow
...
* ids = "any comma separated list of image ids"
...
* Please use the support system at http://wordpress.org/support/plugin/superslider-show
...
**How do I use different graphics and symbols? **
...
* 2.9 (2013/1/27)
  ...
  * changed the default shortcode from gallery to slideshow
  * added the ids option to the shortcode, now if you use the new gallery feature of WordPress 3.5+ where you can select various images from your media library they will display in the slideshow. usage - [slideshow ids="12,13,14"] where the ids numbers are image ids rather than post id.
